...
class LintConfiguration
{
    ...
    public function mergeAtRulesPropertiesStandards(array $standards): void
    {
        ...
        $atRulesPropertiesStandards = array_merge_recursive($this->atRulesPropertiesStandards, $standards);
    ...
    public function mergeAtRulesPropertiesNonStandards(array $nonStandards): void
    {
        ...
        $atRulesPropertiesNonStandards = array_merge_recursive($this->atRulesPropertiesNonStandards, $nonStandards);
