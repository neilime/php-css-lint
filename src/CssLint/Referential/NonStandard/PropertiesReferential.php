...
class PropertiesReferential extends AbstractReferential
{
    ...
    public static array $referential = [
        ...
        'column-rule-inset-cap' => true,
        'column-rule-inset-cap-end' => true,
        'column-rule-inset-cap-start' => true,
        'column-rule-inset-end' => true,
        'column-rule-inset-junction' => true,
        'column-rule-inset-junction-end' => true,
        'column-rule-inset-junction-start' => true,
        ...
        'row-rule-inset' => true,
        'row-rule-inset-cap' => true,
        'row-rule-inset-cap-end' => true,
        'row-rule-inset-cap-start' => true,
        'row-rule-inset-end' => true,
        'row-rule-inset-junction' => true,
        'row-rule-inset-junction-end' => true,
        'row-rule-inset-junction-start' => true,
