...
class PropertiesReferential extends AbstractReferential
{
    ...
    public static array $referential = [
        ...
        'timeline-trigger-activation-range' => true,
        'timeline-trigger-activation-range-end' => true,
        'timeline-trigger-activation-range-start' => true,
        'timeline-trigger-active-range' => true,
        'timeline-trigger-active-range-end' => true,
        'timeline-trigger-active-range-start' => true,
