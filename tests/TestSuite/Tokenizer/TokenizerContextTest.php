...
class TokenizerContextTest extends TestCase
{
    ...
    public function testInitialState(): void
    {
        ...
        $this->assertEquals(new Position(0, 0), $this->context->getCurrentPosition());
    }
    ...
    public function testCurrentPosition(): void
    {
        ...
        $this->assertEquals(0, $initialPosition->getLine());
        $this->assertEquals(0, $initialPosition->getColumn());
    }
}
