...
class TokenizerTest extends TestCase
{
    ...
    {
        // Arrange
        $stream = $this->getStream('@layer utilities { @layer components { .button { display: block; width: 10px; } } }');
        ...
        $expectedTokensOrErrors = [
            ...
            [
                ...
                'value' => [
                    ...
                    [
                        'type' => 'at-rule',
                        'value' => ['name' => 'layer', 'value' => 'components', 'isBlock' => true],
                    ],
                    [
                        'type' => 'block',
                        'value' => [
                            ...
                            [
                                'type' => 'block',
                                'value' => [
                                    ['type' => 'property', 'value' => ['name' => 'display', 'value' => 'block']],
                                ],
                            ],
                        ],
                    ],
